<template>
    ...
    <section class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 sm:gap-16 mb-10">
        ...
        <Trend color="green" title="Investment" :amount="3000" :last-amount="2000" :loading="pending"/>
        <Trend color="red" title="Savings" :amount="3000" :last-amount="4000" :loading="pending"/>
    </section>
