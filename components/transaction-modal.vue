        ...
        <UCard>
            ...
            <UForm :state="state" :schema="schema" ref="form" @submit="save">
                <UFormGroup label="Transaction Type" :required="true" name="type" class="mb-4">
                    <USelect :disabled="isEditing" placeholder="Select Type" :options="types" v-model="state.type"/>
                </UFormGroup>
                ...
                <UFormGroup label="Transaction Date" :required="true" name="created_at" class="mb-4">
                    <UInput type="date" icon="i-lucide-calendar-days" v-model="state.created_at"/>
                </UFormGroup>
